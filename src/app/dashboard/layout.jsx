        ...
        <section className={styles.dashboardContainer}>
            <div className={styles.MultiStepForm}>
                <div className={`${styles.sidebar} ${isSidebarOpen ? styles.open : ""}`}>
                    <Sidebar isSidebarOpen={isSidebarOpen} step={step} toggleSidebar={toggleSidebar} onMenuItemClick={handleMenuItemClick} menuItems={menuItems} />
                    <div className={`overlay ${isSidebarOpen ? 'open' : ''}`} onClick={toggleSidebar}></div>
                </div>
                <main className={styles.contentContainer}>
                    <DashboardHeader selectedStepLabel={selectedStepLabel} isSidebarOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />
                    {children}
                </main>
            </div>
        </section>
